...
class ResponseService {
    ...
    // 성공 결과만 처리하는 메소드
    val successResult: CommonResult = CommonResult(true, CommonResponse.SUCCESS.code, CommonResponse.SUCCESS.msg)

    // 실패 결과만 처리하는 메소드
    val failResult: CommonResult = CommonResult(false, CommonResponse.FAIL.code, CommonResponse.FAIL.msg)
}